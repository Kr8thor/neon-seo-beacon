  ...
  <div class="min-h-screen bg-white">
    ...
    <article class="max-w-4xl mx-auto px-4 py-8">
      ...
      <header class="mb-8">
        ...
        <div
          class="flex items-center justify-between text-sm text-gray-500 border-b border-gray-200 pb-6"
        >
      ...
      <!-- Table of Contents -->
      <div
        v-if="data?.toc && toc?.links?.length"
...
const { setPageMeta, generateArticleSchema, generateBreadcrumbSchema } =
  useSEO();
