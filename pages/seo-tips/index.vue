      ...
      <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Learn the latest SEO strategies, techniques, and best practices to
...
const mockArticles = [
  {
    ...
    description:
      "Master the technical aspects of SEO including site structure, crawling, indexing, and Core Web Vitals optimization.",
    category: "technical",
  ...
  },
  {
    ...
    description:
      "Learn how to create and optimize content that ranks well and provides value to your audience.",
    category: "content",
  ...
  },
  {
    ...
    description:
      "Complete guide to local SEO including Google My Business optimization, local citations, and review management.",
    category: "local",
  ...
  },
  {
    ...
    description:
      "Set up proper SEO tracking and learn which metrics actually indicate SEO success.",
    category: "analytics",
  ...
  },
  {
    ...
    description:
      "Improve your Core Web Vitals scores and boost both user experience and search rankings.",
    category: "technical",
  ...
  },
  {
    ...
    description:
      "Modern keyword research strategies using semantic search and user intent analysis.",
    category: "content",
  ...
  meta: [
    {
      name: "description",
      content:
        "Learn the latest SEO strategies, techniques, and best practices. Comprehensive guides on technical SEO, content optimization, and search rankings.",
    },
    {
      name: "keywords",
      content:
        "SEO tips, SEO guides, search engine optimization, SEO strategies, SEO best practices, technical SEO, content SEO",
    },
  ],
});
</script>
