    ...
    <section class="bg-white border-b">
      <div class="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">
          Start with our free plan and upgrade as your SEO needs grow. 
          All plans include our comprehensive SEO analysis engine.
        </p>
      </div>
    </section>
          ...
          <table class="w-full border-collapse">
            <thead>
              <tr class="border-b-2 border-gray-200">
                ...
                <th class="text-center py-4 px-6 font-semibold text-gray-900">Agency</th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200">
              <tr v-for="feature in features" :key="feature.name">
                ...
                <td class="py-4 px-6 text-center">
                  <component :is="getFeatureIcon(feature.free)" :value="feature.free" />
                </td>
                <td class="py-4 px-6 text-center">
                  <component :is="getFeatureIcon(feature.pro)" :value="feature.pro" />
                </td>
                <td class="py-4 px-6 text-center">
                  <component :is="getFeatureIcon(feature.agency)" :value="feature.agency" />
                </td>
              </tr>
            </tbody>
          </table>
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Choose the perfect SEO audit plan for your needs. Start free and upgrade as you grow.' },
    { property: 'og:title', content: 'Pricing - Neon SEO Beacon' },
    { property: 'og:description', content: 'Choose the perfect SEO audit plan for your needs. Start free and upgrade as you grow.' }
  ]
})
...
const features = [
  ...
  { name: 'Support Level', free: 'Email', pro: 'Priority', agency: 'Dedicated' }
]
...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes! Our Free plan includes 5 audits per month with no time limit. Pro and Agency plans include a 14-day free trial.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, we offer special pricing for qualified nonprofits and educational institutions. Contact us for more information.'
  }
]
