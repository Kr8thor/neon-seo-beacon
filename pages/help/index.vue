...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Get help with Neon SEO Beacon. Find answers to common questions, browse guides, and contact support.' },
    { property: 'og:title', content: 'Help Center - Neon SEO Beacon' },
    { property: 'og:description', content: 'Get help with Neon SEO Beacon. Find answers to common questions, browse guides, and contact support.' }
  ]
})
