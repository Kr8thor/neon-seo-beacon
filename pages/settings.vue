    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
      ...
      <div class="space-y-8">
        ...
        <div class="glass rounded-2xl p-6 border border-white/20">
          ...
          <div class="space-y-4">
            <button class="w-full md:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-colors duration-200">
              Change Password
            </button>
        ...
        <div class="flex justify-end">
          <button class="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-xl transition-all duration-200 hover-scale">
            Save Changes
          </button>
        </div>
      </div>
...
useHead({
  title: 'Settings - Neon SEO Beacon',
  meta: [
