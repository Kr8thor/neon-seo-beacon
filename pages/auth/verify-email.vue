      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <ol class="space-y-3 text-sm text-gray-600">
          <li class="flex items-start">
            <span
              class="flex-shrink-0 w-5 h-5 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-semibold mr-3 mt-0.5"
              >1</span
            >
...
setPageMeta({
  ...
  description:
    "Verify your email address to complete your Neon SEO Beacon account setup.",
});
</script>
