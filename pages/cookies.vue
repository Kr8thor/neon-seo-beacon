    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="prose prose-lg max-w-none">
        ...
        <p>
          ...
          enable core functionality like user authentication and secure access
          to your account.
        </p>
        ...
        <p>
          ...
          own cookies. These services have their own privacy policies governing
...
// Page meta
definePageMeta({
  title: "Cookie Policy - Neon SEO Beacon",
