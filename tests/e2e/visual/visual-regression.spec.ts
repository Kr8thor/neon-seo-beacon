...
test.describe('Visual Regression Testing', () => {
  ...
  test('audit results visual consistency', async ({ page }) => {
    ...
    await page.waitForSelector('[data-testid="audit-completed"]', { timeout: 30000 })
    
    // Take screenshot of results
    await expect(page.locator('[data-testid="audit-results"]')).toHaveScreenshot('audit-results.png', {
      threshold: 0.2,
      maxDiffPixels: 800
    })
  })
