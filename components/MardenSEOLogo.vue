<template>
  <div class="marden-logo-container relative" ref="logoContainer">
    ...
    <!-- Main Logo -->
    <div class="relative z-10 flex items-center justify-center space-x-3" ref="logoMain">
      <!-- Animated Logo Icon -->
      <div class="logo-icon relative" ref="logoIcon">
        <!-- Outer Ring with Pulse -->
        <div class="absolute inset-0 w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 opacity-20 animate-ping"></div>
        
        <!-- Main Icon Circle -->
        <div class="relative w-16 h-16 rounded-full bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 shadow-lg flex items-center justify-center overflow-hidden">
          ...
          <!-- Icon Content -->
          <div class="relative z-10 text-white font-bold text-xl tracking-wider">
            M
          </div>
          
          <!-- Sparkle Effects -->
          <div class="absolute top-2 right-2 w-1 h-1 bg-white rounded-full opacity-80 animate-twinkle"></div>
          <div class="absolute bottom-3 left-2 w-0.5 h-0.5 bg-white rounded-full opacity-60 animate-twinkle-delayed"></div>
        </div>
      </div>

      <!-- Animated Text -->
      <div class="logo-text" ref="logoText">
        <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-700 to-purple-700 bg-clip-text text-transparent dark:from-white dark:via-blue-300 dark:to-purple-300">
          <!-- Animated Letters -->
          <span
        ...
        <p class="mt-2 text-lg text-gray-600 dark:text-gray-300 font-medium" ref="tagline">
...
const createFloatingKeywords = () => {
  const keywords = ['SEO', 'Rankings', 'Analytics', 'Keywords', 'Content', 'Speed', 'UX']
