    ...
    <section class="relative px-6 lg:px-8 pt-16 pb-24">
      <div class="mx-auto max-w-4xl text-center">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
          Get comprehensive website analysis with actionable SEO
          recommendations. Trusted by agencies and businesses worldwide.
        </p>

        <!-- Quick Audit Form -->
        <div class="mt-10 audit-form-enhanced">
          <form
            @submit.prevent="handleQuickAudit"
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            <div
              class="mx-auto w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center mb-4"
            >
              <svg
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Page speed, mobile-friendliness, and technical optimization
              analysis
            </p>
          </div>
          ...
          <div class="text-center">
            <div
              class="mx-auto w-12 h-12 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center mb-4"
            >
              <svg
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Meta tags, headings, keyword optimization, and content structure
            </p>
          </div>

          <div class="text-center">
            <div
              class="mx-auto w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center mb-4"
            >
              <svg
            ...
            <p class="text-gray-600 dark:text-gray-400">
              Core Web Vitals, loading speed, and user experience metrics
            </p>
          </div>
        </div>
      </div>
