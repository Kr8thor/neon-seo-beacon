<template>
  <div class="modern-dashboard min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
    <!-- Custom Cursor -->
    <div
      ref="cursor"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4 animate-slide-in-right">
              ...
              <div class="w-8 h-8 bg-gradient-cosmic rounded-full hover-scale cursor-pointer"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <div class="p-3 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-glow">
      ...
      <section class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          ...
          >
            <div class="flex items-center justify-between mb-6">
              <h3 class="text-xl font-bold text-gray-900 dark:text-white">SEO Performance</h3>
              <div class="flex space-x-2">
                <button
                  v-for="period in ['7D', '30D', '90D']"
                  :key="period"
                  class="px-3 py-1.5 text-sm font-medium rounded-lg transition-all duration-200"
                  :class="activePeriod === period ? 'bg-blue-500 text-white shadow-glow' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100'"
        ...
        <div class="space-y-6">
          ...
          <div class="glass rounded-2xl p-6 scroll-reveal">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Recent Audits</h3>
            <div class="space-y-3">
              <div
                ...
                @mouseleave="handleHoverEnd"
              >
                <div class="w-10 h-10 rounded-full bg-gradient-to-r from-green-400 to-blue-500 flex items-center justify-center text-white font-bold text-sm">
                  {{ audit.score }}
                </div>
                <div class="flex-1">
                  <p class="font-medium text-gray-900 dark:text-white text-sm">{{ audit.url }}</p>
          ...
          <div class="glass rounded-2xl p-6 scroll-reveal">
            ...
            <div class="grid grid-cols-2 gap-3">
              <button
                ...
                @mouseleave="handleHoverEnd"
              >
                <component :is="action.icon" class="w-6 h-6 text-blue-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ action.name }}</p>
              </button>
            </div>
          </div>
      ...
      <section class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- SEO Opportunities -->
        <div class="glass rounded-2xl p-6 scroll-reveal">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">SEO Opportunities</h3>
          <div class="space-y-4">
            <div
              ...
              @mouseleave="handleHoverEnd"
            >
              <div class="w-8 h-8 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 flex items-center justify-center text-white">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ opportunity.description }}</p>
                <div class="flex items-center mt-2 space-x-2">
                  <span class="text-xs px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full">
                    {{ opportunity.impact }}
                  </span>
                  <span class="text-xs text-gray-500">{{ opportunity.effort }}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="glass rounded-2xl p-6 scroll-reveal">
          ...
          <div class="space-y-4">
            <div
              ...
              @mouseleave="handleHoverEnd"
            >
              <div class="w-8 h-8 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 flex items-center justify-center text-white">
