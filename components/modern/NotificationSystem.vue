<template>
  <Teleport to="body">
    <div
      class="notification-container fixed top-4 right-4 z-50 space-y-3 pointer-events-none"
    >
        ...
        >
          ...
          <div class="p-4">
            <div class="flex items-start space-x-3">
              ...
              >
                <XMarkIcon
                  class="w-4 h-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200"
                />
              </button>
            </div>
          </div>
