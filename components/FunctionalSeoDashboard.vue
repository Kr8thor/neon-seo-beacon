<template>
  <div class="functional-seo-dashboard min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
    <!-- Header -->
    <header class="glass-strong border-b border-white/20 backdrop-blur-xl">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center space-x-3">
            <div class="w-10 h-10 bg-gradient-neon rounded-xl flex items-center justify-center shadow-glow">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section class="mb-8">
        <div class="glass rounded-3xl p-8 text-center">
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Enter any website URL to get a comprehensive SEO analysis in minutes. 
            Our advanced tools will scan your site for 50+ SEO factors.
          </p>
          ...
          <form @submit.prevent="createQuickAudit" class="max-w-2xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-3 mt-6">
              ...
              >
                {{ auditType.name }}
                <span class="text-xs opacity-75 ml-1">({{ auditType.duration }})</span>
              </button>
            </div>
          </form>
        </div>
      ...
      <!-- SEO Service Buttons -->
      <section class="mb-8">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">SEO Analysis Tools</h3>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          >
            <div class="w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" v-html="service.icon"></svg>
            </div>
            <h4 class="font-semibold text-gray-900 dark:text-white text-sm">{{ service.name }}</h4>
            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">{{ service.description }}</p>
          </button>
        </div>
      </section>
        ...
        <div class="lg:col-span-2">
          <div class="glass rounded-3xl p-8">
            <div class="flex items-center justify-between mb-6">
              <h3 class="text-xl font-bold text-gray-900 dark:text-white">Recent Audits</h3>
              <button
                @click="loadAudits"
            ...
            <div v-if="loadingAudits" class="text-center py-8">
              ...
              <p class="text-gray-600 dark:text-gray-400 mt-2">Loading audits...</p>
            </div>
            ...
            <div v-else-if="audits.length === 0" class="text-center py-8">
              ...
              <p class="text-gray-600 dark:text-gray-400">No audits yet. Create your first audit above!</p>
            </div>
            ...
            <div v-else class="space-y-4">
              ...
              >
                ...
                <div class="flex-1 min-w-0">
                  <h4 class="font-medium text-gray-900 dark:text-white truncate">{{ audit.url }}</h4>
        ...
        <div class="space-y-6">
          ...
          <div class="glass rounded-2xl p-6">
            ...
            <div class="space-y-3">
              ...
              >
                <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" v-html="action.icon"></svg>
                </div>
                <div class="flex-1">
                  <p class="font-medium text-gray-900 dark:text-white text-sm">{{ action.name }}</p>
    ...
    >
      ...
      >
        <div class="flex items-center justify-between mb-6">
          <h3 class="text-2xl font-bold text-gray-900 dark:text-white">{{ selectedService.name }}</h3>
          <button
            @click="selectedService = null"
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-6">{{ selectedService.fullDescription }}</p>
...
const seoServices = [
  {
    ...
    fullDescription: 'Analyze your page titles, meta descriptions, and other meta tags for SEO optimization.'
  },
  {
    id: 'performance',
    name: 'Performance',
    ...
    fullDescription: 'Test your website loading speed, performance metrics, and optimization opportunities.'
  },
  {
    id: 'mobile-friendly',
    name: 'Mobile Check',
    ...
    fullDescription: 'Check how your website performs on mobile devices and identify mobile SEO issues.'
  },
  {
    id: 'structured-data',
    name: 'Schema',
    ...
    fullDescription: 'Analyze structured data markup and schema implementation for better search visibility.'
  },
  {
    id: 'links',
    name: 'Link Analysis',
    ...
    fullDescription: 'Examine your internal and external link structure for SEO optimization opportunities.'
  },
  {
    id: 'content',
    name: 'Content',
    ...
    fullDescription: 'Analyze your content structure, headings, keyword usage, and content optimization.'
  }
]
...
const statistics = computed(() => [
  ...
  { label: 'Avg Score', value: audits.value.length ? Math.round(audits.value.reduce((sum, audit) => sum + (audit.score || 0), 0) / audits.value.length) : 0 },
  { label: 'Completed', value: audits.value.filter(audit => audit.status === 'completed').length },
  { label: 'This Month', value: audits.value.filter(audit => {
