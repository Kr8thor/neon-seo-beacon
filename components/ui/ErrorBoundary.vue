      ...
      <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 max-w-lg mx-auto">
        <div class="flex items-center">
          <svg class="w-8 h-8 text-red-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.5 0L3.732 16c-.77.833.192 2.5 1.732 2.5z"></path>
          </svg>
          <div>
        ...
        <details v-if="showDetails && errorDetails" class="mt-4">
          ...
          <pre class="mt-2 text-xs bg-red-100 dark:bg-red-900/30 p-3 rounded border overflow-auto max-h-32">{{ errorDetails }}</pre>
        </details>
      </div>
    </div>
  </div>
