<template>
  <div class="animate-pulse">
    ...
    <div
      v-if="type === 'card'"
      class="bg-gray-200 dark:bg-gray-700 rounded-lg p-6 space-y-4"
    >
    ...
    <div
      ...
      class="bg-gray-200 dark:bg-gray-700 rounded-lg p-4"
    >
    ...
    <div v-else-if="type === 'table'" class="space-y-3">
      <div
        class="grid grid-cols-4 gap-4 pb-2 border-b border-gray-200 dark:border-gray-700"
      >
        <div
          v-for="i in 4"
          :key="i"
